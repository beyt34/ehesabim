namespace eHesabim.Web.Portal.Engine {
    public static class RouteNames {
        ...
        public const string CustomerAbstract = "CustomerAbstract";

        public const string BankAccountList = "BankAccountList";
        public const string BankAccountTransactionList = "BankAccountTransactionList";
        public const string BankCreditList = "BankCreditList";
        public const string BankCreditSubList = "BankCreditSubList";
        ...
        public const string PermissionEdit = "PermissionEdit";
