...
namespace eHesabim.Web.Portal.Engine {
    public class BundleConfig {
        public static void RegisterBundles(BundleCollection bundles) {
            ...
            bundles.Add(new StyleBundle(CssBundles.Bootstrap).Include("~/Content/css/bootstrap.min.css", "~/Content/css/bootstrap-social.css", "~/Content/font-awesome/css/font-awesome.min.css"));
            ...
            bundles.Add(new ScriptBundle(JsBundles.JQuery).Include("~/Content/js/jquery-1.10.2.min.js", "~/Content/js/jquery.unobtrusive-ajax.min.js", "~/Content/js/jquery.validate.min.js", "~/Content/js/jquery.validate.unobtrusive.min.js"));
            ...
            bundles.Add(new ScriptBundle(JsBundles.Kendo).Include("~/Content/js/kendo.all.min.js", "~/Content/js/kendo.aspnetmvc.min.js", "~/Content/js/kendo.web.min.js", "~/Content/js/kendo.culture.tr-TR.min.js"));
