...
namespace eHesabim.Core.Engine {
    public class AppDomainTypeFinder : ITypeFinder {
        ...
        private string assemblySkipLoadingPattern = "^System|^mscorlib|^Microsoft|^CppCodeProvider|^VJSharpCodeProvider|^WebDev|^Castle|^Iesi|^log4net|^NHibernate|^nunit|^TestDriven|^MbUnit|^Rhino|^QuickGraph|^TestFu|^Telerik|^ComponentArt|^MvcContrib|^AjaxControlToolkit|^Antlr3|^Remotion|^Recaptcha|^NLog|^Ninject";
        ...
        protected void AddConfiguredAssemblies(List<string> addedAssemblyNames, List<Assembly> assemblies) {
        ...
        protected void LoadMatchingAssemblies(string directoryPath) {
